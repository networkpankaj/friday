      ...
      <ScrollControls pages={6} damping={0.1}>
        ...
        <Scroll html style={{width: '100%'}}>
          ...
          <div className='row' style={{ position: 'absolute', top: `330vh` }}>
            <h2>Grooming with Precision</h2>
            <p style={{ maxWidth: '400px' }}>This cutting-edge aftershave combines the best of grooming science with a sleek, futuristic design. Protect your skin while embracing technology at the same time.</p>
            <button>Read more</button>
          </div>

          <div className='row' style={{ position: 'absolute', top: `450vh` }}>
            <div className='col' style={{ position: 'absolute', right: `40px`, width: "540px" }}>
              <h2 style={{ maxWidth: "440px" }}>Unmatched Quality</h2>
              <p style={{ maxWidth: '440px' }}>Every detail of this aftershave bottle has been carefully designed with precision. With advanced technology, the experience of grooming reaches a whole new level.</p>
              <button>Read more</button>
            </div>
          </div>

          <h2 style={{ position: 'absolute', top: '550vh', left: '50%', transform: `translate(-50%,-50%)` }}>Cutting-Edge of Grooming</h2>              

          <button style={{ position: 'absolute', top: `590vh`, left: '50%', transform: `translate(-50%,-50%)` }}>Book a Consultation</button>
